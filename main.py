...
def train_test_val_split(frame_data,mask_data):
    n = len(frame_data)
    a = int(n*0.75)
    b = int(n*0.85)
...
def main():
    ...
    if opt.isTrain:
        ...
        input_train, input_val, input_test, label_train, label_val, label_test = train_test_val_split(frame_data,mask_data)
